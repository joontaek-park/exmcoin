// Copyright (c) 2009-2010 Satoshi Nakagmoto
...
uint256 hashGenesisBlock("0xdd32426ebb4e80534829c677ea0674c00262207923b6a2fc70dd1853f7735ca2");
uint256 hashGenesisBlockMerkleRoot("0xdd32426ebb4e80534829c677ea0674c00262207923b6a2fc70dd1853f7735ca2");

static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Exmcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Exmcoin Signed Message:\n";
...
{
    // Exmcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 2592000); // Exmcoin: 2,592k blocks in ~6 months

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 60 * 60;	// Exmcoin: retarget every 2 Minute
static const int64 nTargetSpacing = 6;			// Exmcoin: 6 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Exmcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    /*
    // Exmcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Exmcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdd32426ebb4e80534829c677ea0674c00262207923b6a2fc70dd1853f7735ca2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Ex Machina Coin, Earlier begining of 2050";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("012145898fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1507021903;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1683128;
        ...
        assert(block.hashMerkleRoot == uint256("0xa08ddae780dfe650649235ab9860e792ccebb01262dede9e7b931605cecea67b"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Exmcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ExmcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ExmcoinMiner : ProcessBlock, block not accepted");
    }
